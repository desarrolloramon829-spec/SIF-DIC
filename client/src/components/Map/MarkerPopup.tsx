  ...
  return (
    <Popup>
      <div className="marker-popup">
        <h4>{tipo === 'ingreso' ? '📍 Punto de Ingreso' : '🔍 Punto de Hallazgo/Rescate'}</h4>
        ...
        <div className="popup-field">
          <strong>Sexo:</strong> {hecho.sexo === 'masculino' ? 'Masculino' : 'Femenino'} — <strong>Edad:</strong> {hecho.edad === 0 ? 'S/D' : hecho.edad}
        </div>
        <div className="popup-field">
        ...
        <div className="popup-field">
          <strong>Fecha del hecho:</strong> {new Date(hecho.fecha_del_hecho).toLocaleDateString('es-AR')}
        </div>
        {hecho.fecha_del_habido && (
          <div className="popup-field">
            <strong>Fecha del habido:</strong> {new Date(hecho.fecha_del_habido).toLocaleDateString('es-AR')}
          </div>
        )}
      </div>
    </Popup>
